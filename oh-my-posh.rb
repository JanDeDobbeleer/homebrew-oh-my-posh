class OhMyPosh < Formula
  ...
  url "https://github.com/JanDeDobbeleer/oh-my-posh/archive/v3.154.1.tar.gz"
  sha256 "78a76d59b916ad8ebaacbf682b5ce24c0c6d554a439f11af991c23648ddb379b"
  ...
  def install
    Dir.chdir("src") do
      system("go build -o=oh-my-posh -ldflags=\"-X \'main.Version=3.154.1\'\"")

class OhMyPosh < Formula
  ...
  url "https://github.com/JanDeDobbeleer/oh-my-posh/archive/v17.5.0.tar.gz"
  head "https://github.com/JanDeDobbeleer/oh-my-posh.git", branch: "main"
  sha256 "99cfb32fcfda96c6c76f582e6794432a36d3ddfc94117fb437894cc5a692ec51"
  license "MIT"
  version "17.5.0"
  ...
  def install
    Dir.chdir("src") do
      ...
      system("go build -o=oh-my-posh -ldflags=\"-s -w -X \'main.Version=17.5.0\'\"")

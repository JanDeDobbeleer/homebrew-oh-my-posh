class OhMyPosh < Formula
  ...
  url "https://github.com/JanDeDobbeleer/oh-my-posh/archive/v16.6.0.tar.gz"
  head "https://github.com/JanDeDobbeleer/oh-my-posh.git", branch: "main"
  sha256 "4da78bf1c0748da588a665c2ca3bcbed18249498ec98cd63777d9bce58c72886"
  license "MIT"
  version "16.6.0"
  ...
  def install
    Dir.chdir("src") do
      ...
      system("go build -o=oh-my-posh -ldflags=\"-s -w -X \'main.Version=16.6.0\'\"")

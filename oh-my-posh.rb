class OhMyPosh < Formula
  ...
  url "https://github.com/JanDeDobbeleer/oh-my-posh/archive/v14.13.0.tar.gz"
  head "https://github.com/JanDeDobbeleer/oh-my-posh.git", branch: "main"
  sha256 "4cd52d5174c380140d20a64b12a869068caefc8f88e6892cdd5b0f6f37b16c50"
  license "MIT"
  version "14.13.0"
  ...
  def install
    Dir.chdir("src") do
      ...
      system("go build -o=oh-my-posh -ldflags=\"-s -w -X \'main.Version=14.13.0\'\"")

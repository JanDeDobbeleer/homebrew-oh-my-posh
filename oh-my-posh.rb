class OhMyPosh < Formula
  ...
  url "https://github.com/JanDeDobbeleer/oh-my-posh/archive/v3.144.0.tar.gz"
  sha256 "86863aa0635e74e8d98f9b8cc24ffe4fbfe635bfc78461d7676847a56538bb95"
  ...
  def install
    Dir.chdir("src") do
      system("go build -o=oh-my-posh -ldflags=\"-X \'main.Version=3.144.0\'\"")

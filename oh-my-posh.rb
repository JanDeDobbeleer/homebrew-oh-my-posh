class OhMyPosh < Formula
  ...
  url "https://github.com/JanDeDobbeleer/oh-my-posh/archive/v14.31.0.tar.gz"
  head "https://github.com/JanDeDobbeleer/oh-my-posh.git", branch: "main"
  sha256 "8a2caf5c1aaa4fcd82adff9cf6e4ca463fd33da226eae3258852f02eeaba5462"
  license "MIT"
  version "14.31.0"
  ...
  def install
    Dir.chdir("src") do
      ...
      system("go build -o=oh-my-posh -ldflags=\"-s -w -X \'main.Version=14.31.0\'\"")

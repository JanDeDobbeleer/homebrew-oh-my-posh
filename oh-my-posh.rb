class OhMyPosh < Formula
  ...
  url "https://github.com/JanDeDobbeleer/oh-my-posh/archive/v12.35.1.tar.gz"
  head "https://github.com/JanDeDobbeleer/oh-my-posh.git", branch: "main"
  sha256 "e412aa5ca3614fd31d51bf4a0d698d615538f5e47cef5d51c74bf80b31d22e53"
  license "MIT"
  version "12.35.1"
  ...
  def install
    Dir.chdir("src") do
      ...
      system("go build -o=oh-my-posh -ldflags=\"-s -w -X \'main.Version=12.35.1\'\"")
